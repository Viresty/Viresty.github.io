...
const MonsterCard = (props) => {
  ...
  return (
    <div className="card">
      <div className='backgroundEffect' style={{height: "140%", width: "140%"}}>
        <svg className='choseMonster' xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
		...
		c5.613,2.785,5.613,8.411,5.613,16.821C204.823,151.526,196.403,162.742,182.385,162.742L182.385,162.742z"/>
            <path d="M50,200 L0,200 L137,350 L50,200 Z" />
            <path d="M224,200 L274,200 L137,350 L224,200 Z" />
        </svg>
      </div>
            ...
            <div className='cardStat'>
              <div className='cardStatContent' style={{backgroundColor: 'orange'}}>
                ...
                <div className='cardStatMoreInfo'>
                  ...
                  <p>Mức độ tăng trưởng theo cấp: +{props.CardDetail.detail.stat.ATK.lvPowerUp}</p>
                </div>
              </div>
              ...
              <div className='cardStatContent' style={{backgroundColor: 'purple'}}>
                <p>{props.CardDetail.detail.stat.ATKSPD.value}</p>
                <div className='cardStatMoreInfo'>
                  <h1>TỐC ĐỘ TẤN CÔNG:</h1>
                  <p>Số đòn tấn công có thể thực hiện trong lượt.</p>
                  <p>Mức độ tăng trưởng theo cấp: {props.CardDetail.detail.stat.ATKSPD.lvPowerUp>0?
                    "+"+props.CardDetail.detail.stat.ATKSPD.lvPowerUp:
                    props.CardDetail.detail.stat.ATKSPD.lvPowerUp}</p>
                </div>
              </div>
              <div className='cardStatContent' style={{backgroundColor: 'green'}}>
                <p>{props.CardDetail.detail.stat.SPD.value}</p>
                <div className='cardStatMoreInfo'>
                  <h1>TỐC ĐỘ DI CHUYỂN:</h1>
                  <p>Thời gian đợi đến lượt tiếp theo.</p>
                  <p>Mức độ tăng trưởng theo cấp: {props.CardDetail.detail.stat.SPD.lvPowerUp>0?
